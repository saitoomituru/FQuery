...
| `packages/ui-react/` | React + React Flow Presentation component |
...
依存方向はUI/Host→Core contract、plugin→Plugin SDK、Core→FAMLog portとする。CoreからReact、Host、実pluginへ依存しない。
