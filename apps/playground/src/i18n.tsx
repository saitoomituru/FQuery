...
export type MessageKey = "app.title" | "app.lastEvent" | "app.frameAll" | "unit.replace" | "unit.why" | "unit.whyRunning" | "unit.details" | "unit.dimension" | "unit.evidence" | "lambda.stale" | "lambda.empty";
